...
const RADIOLOGISTS = [
  {
    id: 'gabboud',
    name: name('Ghadi', 'Abboud', 'MD'),
    title: 'MD',
    specialties: ['Body', 'General'],
    remote: false,
  },
  {
    id: 'cburch',
    name: name('Cassandra', 'Burch', 'PA'),
    title: 'PA',
    specialties: ['IR'],
    remote: false,
  },
  ...
  {
    id: 'jchoi',
    name: name('James', 'Choi', 'MD'),
    title: 'MD',
    specialties: ['MSK', 'General'],
    remote: false,
  },
  {
    id: 'aessenmacher',
    name: name('Alex', 'Essenmacher', 'MD'),
    title: 'MD',
    specialties: ['General'],
    remote: false,
  },
  {
    id: 'mfazio',
    name: name('Michael', 'Fazio', 'DO'),
    title: 'DO',
    specialties: ['MSK', 'Neuro', 'Breast'],
    remote: false,
  },
  {
    id: 'agieseke',
    name: name('Ashley', 'Gieseke', 'PA'),
    title: 'PA',
    specialties: ['IR'],
    remote: false,
  },
  {
    id: 'wheggen',
    name: name('William', 'Heggen', '-'),
    title: '-',
    specialties: ['General', 'Breast'],
    remote: false,
  },
  {
    id: 'zhill',
    name: name('Zachary', 'Hill', 'DO'),
    title: 'DO',
    specialties: ['General'],
    remote: true,
  },
  {
    id: 'nhilpipre',
    name: name('Nicholas', 'Hilpipre', 'DO'),
    title: 'DO',
    specialties: ['Breast', 'General', 'Peds', 'PET'],
    remote: false,
  },
  {
    id: 'rholdsworth',
    name: name('Ryan', 'Holdsworth', 'MD'),
    title: 'MD',
    specialties: ['Neuro', 'General', 'PET'],
    remote: false,
  },
  {
    id: 'ahurlbut',
    name: name('Aaron', 'Hurlbut', 'MD'),
    title: 'MD',
  ...
  {
    id: 'pjabour',
    name: name('Paul', 'Jabour', 'MD'),
    title: 'MD',
    specialties: ['MSK', 'Breast', 'PET'],
    remote: false,
  },
  {
    id: 'mjulian',
    name: name('Mark', 'Julian', 'DO'),
    title: 'DO',
    specialties: ['General', 'Breast'],
    remote: false,
  },
  ...
  {
    id: 'okaufman',
    name: name('Olaf', 'Kaufman', 'MD'),
    title: 'MD',
    specialties: ['IR', 'General', 'Cardiac'],
    remote: false,
  },
  {
    id: 'bking',
    name: name('Bradley', 'King', 'DO'),
    title: 'DO',
    specialties: ['Body', 'General', 'Peds'],
    remote: false,
  },
  {
    id: 'bkliewer',
    name: name('Bradley', 'Kliewer', 'DO'),
    title: 'DO',
    specialties: ['Breast', 'General', 'Cardiac'],
    remote: false,
  },
  {
    id: 'dlacey',
    name: name('David', 'Lacey', 'MD'),
    title: 'MD',
    specialties: ['IR', 'General'],
    remote: false,
  },
  {
    id: 'aliudahl',
    name: name('Adam', 'Liudahl', 'MD'),
    title: 'MD',
    specialties: ['Neuro', 'General'],
    remote: false,
  },
  ...
  {
    id: 'apeters',
    name: name('Austin', 'Peters', 'DO'),
    title: 'DO',
    specialties: ['General', 'Breast', 'Cardiac'],
    remote: false,
  },
  {
    id: 'jrappleye',
    name: name('Jeffrey', 'Rappleye', 'MD'),
    title: 'MD',
    specialties: ['Neuro', 'General', 'PET'],
    remote: false,
  },
  {
    id: 'briebe',
    name: name('Blake', 'Riebe', 'DO'),
    title: 'DO',
    specialties: ['MSK', 'Breast', 'General', 'PET'],
    remote: false,
  },
  {
    id: 'mshaikh',
    name: name('Mohammed', 'Shaikh', 'MD'),
    title: 'MD',
    specialties: ['Body', 'General'],
    remote: false,
  },
  {
    id: 'jsmith',
    name: name('Jordan', 'Smith', 'DO'),
    title: 'DO',
    specialties: ['General', 'Body', 'PET'],
    remote: false,
  },
  {
    id: 'msoe',
    name: name('Michael', 'Soe', 'MD'),
    title: 'MD',
    specialties: ['General', 'Breast'],
    remote: true,
  },
  {
    id: 'bsteinberg',
    name: name('Brent', 'Steinberg', 'MD'),
    title: 'MD',
    specialties: ['General', 'Peds'],
    remote: false,
  },
  {
    id: 'astone',
    name: name('Alan', 'Stone', 'MD'),
    title: 'MD',
    specialties: ['Breast', 'General'],
    remote: false,
  },
  {
    id: 'bstradling',
    name: name('Benjamin', 'Stradling', 'DO'),
    title: 'DO',
    specialties: ['IR', 'General'],
    remote: false,
  },
  {
    id: 'cwaddell',
    name: name('Christopher', 'Waddell', 'DO'),
    title: 'DO',
    specialties: ['Breast', 'General'],
    remote: true,
  },
...
const toDay = (d) =>
  Math.floor(new Date(d + 'T00:00:00Z').getTime() / 86400000);
...
const fmtCountdown = (ms) => {
  if (ms <= 0) return 'Due for a raise';
...
const STEP = 5000;
const RAISE_WINDOW_MS = 1000 * 60 * 60 * 24;
  ...
  return [
    {
      ...
      postedBy: 'rholdsworth',
      currentPrice: 20000,
      nextRaiseAt: now + 1000 * 60 * 60 * 10,
      status: 'open',
      claimedBy: null,
      history: [
    ...
    {
      id: 'a2',
      label: 'Sunday Day Coverage',
      date: 'Sun, Aug 9',
      specialty: 'MSK',
      requiresOnSite: true,
      postedBy: 'jchoi',
      currentPrice: 15000,
      nextRaiseAt: now + 1000 * 60 * 60 * 24 * 2,
      status: 'open',
      claimedBy: null,
      history: [
        { event: 'listed', price: 15000, ts: now - 1000 * 60 * 60 * 4 },
      ],
    },
    {
      id: 'a3',
      ...
      postedBy: 'okaufman',
      currentPrice: 15000,
      nextRaiseAt: now + 1000 * 60 * 60 * 24,
      status: 'open',
      claimedBy: null,
      history: [
        { event: 'listed', price: 15000, ts: now - 1000 * 60 * 60 * 2 },
      ],
    },
    {
      id: 'a4',
...
const seedTrades = () => [
  {
    ...
    proposedBy: 'mfazio',
    status: 'pending',
    note: 'Swap my Aug 10\u201314 week for your Sept 1\u20135 week',
  },
  {
    id: 't2',
    reqAId: 'v-bking-1',
    reqBId: 'v-nhilpipre-1',
    proposedBy: 'bking',
    status: 'pending',
    note: 'Swap my Aug 20\u201321 for your Sept 10\u201312',
  },
];
...
export default function App() {
  ...
  const [postForm, setPostForm] = useState({
    ...
    specialty: RADIOLOGISTS[0].specialties[0],
    requiresOnSite: true,
  });
  ...
  useEffect(() => {
    setPostForm((f) => ({
      ...f,
      specialty: currentUser.specialties.includes(f.specialty)
        ? f.specialty
        : currentUser.specialties[0],
    }));
  }, [currentUserId]);
  ...
  function coverageAvailable(
    ...
    RADIOLOGISTS.forEach((r) => {
      ...
      const isOff = vacationRequests.some(
        (v) =>
          v.radId === r.id &&
          (v.status === 'approved' || v.status === 'overridden') &&
          !excludeReqIds.includes(v.id) &&
          dateStr >= v.start &&
          dateStr <= v.end
      );
      if (!isOff) count++;
  ...
  function checkRange(radId, start, end, excludeReqIds = []) {
    ...
    dateRange(start, end).forEach((d) => {
      rad.specialties.forEach((sp) => {
        ...
        if (avail < min)
          violations.push({ date: d, specialty: sp, avail, min });
      });
    });
    return violations;
  }
  function summarizeViolations(violations) {
    ...
    return Object.entries(bySpecialty).map(
      ([sp, days]) => `${sp} below minimum on ${days} day${days > 1 ? 's' : ''}`
    );
  }

  const vacPreviewViolations =
    currentUser && vacForm.start && vacForm.end && vacForm.end >= vacForm.start
  ...
  function submitVacationRequest() {
    ...
    setVacationRequests((prev) => [
      ...prev,
      {
        ...
        status: violations.length ? 'flagged' : 'approved',
        openToTrade: false,
      },
    ]);
  }
  function overrideRequest(id) {
    setVacationRequests((prev) =>
      prev.map((v) => (v.id === id ? { ...v, status: 'overridden' } : v))
    );
  }
  ...
  function toggleOpenToTrade(id) {
    setVacationRequests((prev) =>
      prev.map((v) => (v.id === id ? { ...v, openToTrade: !v.openToTrade } : v))
    );
  }
  ...
  function reviewTrade(trade) {
    ...
    const violA = checkRange(reqA.radId, reqB.start, reqB.end, [
      reqA.id,
      reqB.id,
    ]);
    const violB = checkRange(reqB.radId, reqA.start, reqA.end, [
      reqA.id,
      reqB.id,
    ]);
  ...
  function finalizeTrade(trade) {
    ...
    const violA = review
      ? review.violA
      : checkRange(reqA.radId, reqB.start, reqB.end, [reqA.id, reqB.id]);
    const violB = review
      ? review.violB
      : checkRange(reqB.radId, reqA.start, reqA.end, [reqA.id, reqB.id]);
    setVacationRequests((prev) =>
      prev.map((v) => {
        if (v.id === reqA.id)
          return {
            ...
            status: violA.length ? 'overridden' : 'approved',
            openToTrade: false,
          };
        if (v.id === reqB.id)
          return {
            ...
            status: violB.length ? 'overridden' : 'approved',
            openToTrade: false,
          };
        return v;
      })
    ...
    setAuctions((prev) =>
      prev.map((a) => {
        ...
        return {
          ...
          nextRaiseAt: Date.now() + RAISE_WINDOW_MS,
          history: [
            ...a.history,
            { event: 'raised', price: newPrice, ts: Date.now() },
          ],
        };
      })
    );
    ...
    setAuctions((prev) =>
      prev.map((a) => {
        ...
        return {
          ...
          history: [
            ...a.history,
            { event: 'withdrawn', price: a.currentPrice, ts: Date.now() },
          ],
        };
      })
    );
  ...
  function postShift() {
    ...
    setAuctions((prev) => [
      ...prev,
      {
        ...
        date: postForm.date,
        specialty: postForm.specialty,
        requiresOnSite: postForm.requiresOnSite,
        ...
        history: [
          {
            event: 'listed',
            price: Number(postForm.startPrice) || START_PRICE,
            ts: Date.now(),
          },
        ],
      },
    ...
    setPostForm({
      ...
      date: '',
      startPrice: START_PRICE,
      specialty: currentUser.specialties[0],
      requiresOnSite: true,
    });
  }
  ...
  const openAuctions = auctions
    ...
    .sort((x, y) => x.nextRaiseAt - y.nextRaiseAt);
    ...
    <div className="flex h-full min-h-[720px] w-full bg-[#f8f8f8] text-[#222222] font-sans">
      <div className="w-60 shrink-0 bg-[#1c172e] text-[#f8f8f8] flex flex-col">
        <div className="flex items-center gap-3 px-5 py-5 border-b border-white/10">
          <div className="w-9 h-9 rounded-lg bg-[#635cc6] flex items-center justify-center font-bold text-[#f8f8f8] text-sm">
            IR
          </div>
          <div>
            ...
            >
              {RADIOLOGISTS.map((r) => (
                <option key={r.id} value={r.id}>
                  {r.name} &middot; {r.specialties.join(', ')}
                  {r.remote ? ' \u2014 Remote' : ''}
                </option>
              ))}
            </select>
        ...
        <div className="flex-1 overflow-y-auto p-6">
          ...
          {tab === 'vacation' && (
            <VacationTab
              ...
              vacPreviewViolations={vacPreviewViolations}
              summarizeViolations={summarizeViolations}
              submitVacationRequest={submitVacationRequest}
              overrideRequest={overrideRequest}
              withdrawRequest={withdrawRequest}
              toggleOpenToTrade={toggleOpenToTrade}
              idsInPendingTrades={idsInPendingTrades}
              trades={trades}
              ...
              proposalMyReq={proposalMyReq}
              setProposalMyReq={setProposalMyReq}
  ...
  return (
    <button
      ...
      className={`w-full flex items-center gap-2.5 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors ${
        active
          ? 'bg-[#635cc6] text-white'
          : 'text-[#e6e7e8]/80 hover:bg-white/5 hover:text-white'
      }`}
    >
      <Icon size={16} />
      {label}
    ...
    <div className="max-w-3xl">
      <div className="flex items-center justify-between mb-4">
        <p className="text-sm text-[#222222]/70">
          Ascending ask price: shifts list at ${START_PRICE.toLocaleString()}.
          If no one takes it, the price steps up by ${STEP.toLocaleString()}{' '}
          until someone accepts &mdash; or the poster pulls the listing.
        </p>
        <button
      ...
      {showPostForm && (
        <div className="bg-white border border-[#e6e7e8] rounded-xl p-4 mb-5">
          <div className="grid grid-cols-4 gap-3">
            <div>
              <label className="text-xs font-medium text-[#222222]/60">
                Shift
              </label>
              <input
            ...
            <div>
              ...
              <select
                value={postForm.specialty}
                onChange={(e) =>
                  setPostForm({ ...postForm, specialty: e.target.value })
                }
                className="w-full mt-1 border border-[#e6e7e8] rounded-md px-2 py-1.5 text-sm bg-white"
              >
                {currentUser.specialties.map((sp) => (
            ...
            <div>
              ...
              <input
                type="number"
                step={STEP}
                value={postForm.startPrice}
                onChange={(e) =>
                  setPostForm({ ...postForm, startPrice: e.target.value })
                }
                className="w-full mt-1 border border-[#e6e7e8] rounded-md px-2 py-1.5 text-sm"
              />
            </div>
          ...
          <label className="flex items-center gap-2 mt-3 text-sm text-[#211c35] select-none">
            <input
              ...
              onChange={(e) =>
                setPostForm({ ...postForm, requiresOnSite: e.target.checked })
              }
              className="w-4 h-4 accent-[#635cc6]"
            />
            Required On-Site
            <span className="text-xs text-[#222222]/50 font-normal">
              (uncheck if this shift can be worked remotely)
            </span>
          </label>
          <div className="text-xs text-[#222222]/50 mt-2">
            Only radiologists certified in {postForm.specialty} will be able to
            claim it
            {postForm.requiresOnSite
              ? ', and remote-only providers will be excluded'
              : ''}
            .
          </div>
          <div className="flex gap-2 mt-3">
            <button
              onClick={postShift}
              className="bg-[#211c35] text-white text-sm font-medium px-3 py-1.5 rounded-md"
            >
              Post Listing
            </button>
            <button
              onClick={() => setShowPostForm(false)}
              className="text-sm text-[#222222]/60 px-3 py-1.5"
            >
              Cancel
            </button>
          </div>
      ...
      <div className="space-y-2">
        {settledAuctions.map((a) => (
          <div
            key={a.id}
            className="bg-white border border-[#e6e7e8] rounded-lg px-4 py-3 flex items-center justify-between text-sm"
          >
            <div>
              <span className="font-medium">{a.label}</span> &middot; {a.date}{' '}
              &middot; <SpecialtyBadge specialty={a.specialty} />
            </div>
            <div className="text-[#222222]/70">
              {a.status === 'claimed' ? (
                <>
                  Taken by{' '}
                  <span className="font-medium text-[#211c35]">
                    {radById(a.claimedBy).name}
                  </span>{' '}
                  at {fmtMoney(a.currentPrice)}
                </>
              ) : (
                <>
                  Withdrawn at {fmtMoney(a.currentPrice)} &mdash; not worth it
                  to the poster
                </>
              )}
            </div>
...
function AuctionCard({
  ...
  const specialtyMatches = RADIOLOGISTS.filter(
    (r) =>
      r.specialties.includes(auction.specialty) && r.id !== auction.postedBy
  );
  const eligible = auction.requiresOnSite
    ? specialtyMatches.filter((r) => !r.remote)
    : specialtyMatches;
  ...
  const canClaim =
    userHasSpecialty &&
    currentUser.id !== auction.postedBy &&
    !userBlockedByOnSite;
  const isPoster = currentUser.id === auction.postedBy;
  const noEligible = eligible.length === 0;
  const remaining = auction.nextRaiseAt - now;
  const dueForRaise = remaining <= 0;
    ...
    <div className="bg-white border border-[#e6e7e8] rounded-xl p-4">
      <div className="flex items-start justify-between">
        <div>
          <div className="flex items-center gap-2 mb-1">
            <span className="font-semibold text-[#211c35]">
              {auction.label}
            </span>
        ...
        <div
          className={`flex items-center gap-1 text-xs font-semibold px-2 py-1 rounded-md ${
            dueForRaise
              ? 'bg-[#966eed]/20 text-[#4a449c]'
              : 'bg-[#e6e7e8] text-[#211c35]'
          }`}
        >
          <Clock size={12} />{' '}
          {dueForRaise
            ? 'Eligible for a raise'
            : `Next raise in ${fmtCountdown(remaining)}`}
        </div>
      </div>
      ...
      <div className="flex items-center justify-between mt-3 pt-3 border-t border-[#e6e7e8]">
        <div className="text-sm flex items-center gap-1.5">
          ...
          <span className="font-semibold text-[#4a449c] text-base">
            {fmtMoney(auction.currentPrice)}
          </span>
          {auction.history.filter((h) => h.event === 'raised').length > 0 && (
            <span className="flex items-center gap-1 text-xs text-[#966eed]">
              <TrendingUp size={12} /> raised{' '}
              {auction.history.filter((h) => h.event === 'raised').length}x
            </span>
          )}
        </div>
        {isPoster && (
          <div className="flex gap-2">
            <button
              onClick={() => raisePrice(auction)}
              className="flex items-center gap-1 text-xs text-[#4a449c] border border-[#e6e7e8] rounded-md px-2 py-1 hover:bg-[#f8f8f8]"
            >
              <TrendingUp size={12} /> Raise by ${STEP.toLocaleString()} (demo)
            </button>
            <button
              onClick={() => withdrawListing(auction)}
              className="flex items-center gap-1 text-xs text-[#222222]/60 border border-[#e6e7e8] rounded-md px-2 py-1 hover:bg-[#f8f8f8]"
            >
      ...
      {noEligible ? (
        <div className="mt-3 flex items-center gap-2 text-xs text-[#966eed] bg-[#966eed]/10 rounded-md px-3 py-2">
          ...
          {auction.requiresOnSite ? 'on-site-capable ' : ''}
          {auction.specialty}-qualified radiologists in the network &mdash; no
          price will fill this internally.
        </div>
      ) : canClaim ? (
        <div className="mt-3">
          <button
            onClick={() => claimShift(auction)}
            className="bg-[#635cc6] hover:bg-[#4a449c] text-white text-sm font-medium px-4 py-2 rounded-md"
          >
      ...
      <div className="mt-3 flex flex-wrap gap-1.5">
        {auction.history.map((h, i) => (
          <span
            key={i}
            className="text-xs px-2 py-0.5 rounded-full bg-[#e6e7e8] text-[#211c35]"
          >
            {h.event === 'listed' && `Listed at ${fmtMoney(h.price)}`}
            {h.event === 'raised' && `Raised to ${fmtMoney(h.price)}`}
            {h.event === 'claimed' &&
              `Taken at ${fmtMoney(h.price)} by ${radById(h.by).name.replace(
                'Dr. ',
                ''
              )}`}
          </span>
...
function VacationTab({
  ...
  const boardListings = vacationRequests.filter(
    (v) =>
      v.openToTrade &&
      v.radId !== currentUser.id &&
      v.status === 'approved' &&
      !idsInPendingTrades.has(v.id)
  );
  const myEligibleToOffer = myRequests.filter(
    (v) => v.status === 'approved' && !idsInPendingTrades.has(v.id)
  );

  return (
    <div className="max-w-3xl space-y-8">
      <div>
        <h3 className="text-sm font-semibold text-[#211c35] mb-2">
          Request time off
        </h3>
        <div className="bg-white border border-[#e6e7e8] rounded-xl p-4">
          <div className="flex items-end gap-3">
            <div>
              ...
              <input
                ...
                value={vacForm.start}
                onChange={(e) =>
                  setVacForm({ ...vacForm, start: e.target.value })
                }
            ...
            <div>
              ...
              <input
                ...
                value={vacForm.end}
                onChange={(e) =>
                  setVacForm({ ...vacForm, end: e.target.value })
                }
                className="block mt-1 border border-[#e6e7e8] rounded-md px-2 py-1.5 text-sm"
              />
            </div>
            <button
              ...
              className="bg-[#635cc6] hover:bg-[#4a449c] text-white text-sm font-medium px-3 py-2 rounded-md"
            >
              Submit Request
            </button>
            <span className="text-xs text-[#222222]/50">
              as {currentUser.name} &middot;{' '}
          ...
          {vacPreviewViolations.length > 0 ? (
            <div className="mt-3 flex items-start gap-2 text-xs text-[#966eed] bg-[#966eed]/10 rounded-md px-3 py-2">
              ...
              <span>
                ...
                {summarizeViolations(vacPreviewViolations).join('; ')}.
                Submitting will flag this request for admin override instead of
                auto-approving.
              </span>
            </div>
          ) : (
            <div className="mt-3 flex items-center gap-2 text-xs text-[#4a449c] bg-[#635cc6]/10 rounded-md px-3 py-2">
              <CheckCircle2 size={14} /> Coverage holds for all of{' '}
              {currentUser.name.replace('Dr. ', '')}'s specialties &mdash; this
              would auto-approve.
            </div>
          )}
        </div>
      ...
      <div>
        ...
        <div className="space-y-2">
          {myRequests.length === 0 && (
            <div className="text-sm text-[#222222]/50">No requests yet.</div>
          )}
          {myRequests.map((v) => (
            <RequestRow
              key={v.id}
              ...
              withdrawRequest={withdrawRequest}
              toggleOpenToTrade={toggleOpenToTrade}
              lockedInTrade={idsInPendingTrades.has(v.id)}
            />
          ))}
        </div>
      </div>
      ...
      <div>
        <h3 className="text-sm font-semibold text-[#211c35] mb-2">
          Network vacation calendar
        </h3>
        <div className="space-y-2">
          {vacationRequests
            .filter((v) => v.radId !== currentUser.id)
            .map((v) => (
              <RequestRow
                key={v.id}
                v={v}
      ...
      {/* Trade board */}
      <div>
        <h3 className="text-sm font-semibold text-[#211c35] mb-2 flex items-center gap-1.5">
          <Tag size={14} /> Vacation trade board
        </h3>
        <p className="text-xs text-[#222222]/60 mb-2">
          Weeks colleagues have posted as open to trade. Propose one of your own
          approved weeks in exchange.
        </p>
        <div className="space-y-2">
          {boardListings.length === 0 && (
            <div className="text-sm text-[#222222]/50">
              No weeks posted for trade right now.
            </div>
          )}
          {boardListings.map((v) => {
            ...
            return (
              <div
                key={v.id}
                className="bg-white border border-[#e6e7e8] rounded-lg px-4 py-3 text-sm"
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-[#222222]/60">
                      {fmtShort(v.start)} &ndash; {fmtShort(v.end)}
                    </span>
                  </div>
                  {!isProposing && (
                    <button
                      onClick={() => {
                        setProposalTarget(v.id);
                        setProposalMyReq('');
                      }}
                  ...
                  <div className="mt-3 pt-3 border-t border-[#e6e7e8]">
                    {myEligibleToOffer.length === 0 ? (
                      <div className="text-xs text-[#222222]/50">
                        You don't have an approved vacation week available to
                        offer in trade.
                      </div>
                    ) : (
                      <div className="flex items-center gap-2">
                        ...
                        >
                          ...
                          {myEligibleToOffer.map((mv) => (
                            <option key={mv.id} value={mv.id}>
                              {fmtShort(mv.start)}&ndash;{fmtShort(mv.end)}
                            </option>
                          ))}
                        </select>
                        <button
                        ...
                        <button
                          ...
                          className="text-xs text-[#222222]/60 px-2 py-1.5"
                        >
                          Cancel
                        </button>
                      </div>
      ...
      <div>
        <h3 className="text-sm font-semibold text-[#211c35] mb-2 flex items-center gap-1.5">
          <ArrowRightLeft size={14} /> Pending & completed trades
        </h3>
        <div className="space-y-3">
          {trades.length === 0 && (
            <div className="text-sm text-[#222222]/50">No trades yet.</div>
          )}
          {trades.map((t) => (
            <TradeCard
              key={t.id}
  ...
  return (
    <div className="bg-white border border-[#e6e7e8] rounded-lg px-4 py-3 flex items-center justify-between text-sm">
      <div className="flex items-center gap-3">
        ...
        {v.openToTrade && (
          <span className="text-xs font-semibold px-2 py-0.5 rounded-full bg-[#635cc6]/10 text-[#4a449c] flex items-center gap-1">
            <Tag size={10} /> On trade board
          </span>
        )}
      </div>
      <div className="flex items-center gap-2">
        ...
        >
          {v.status === 'flagged'
            ? 'Coverage gap \u2014 needs review'
            : v.status}
        </span>
        {!readOnly && v.status === 'flagged' && (
          <button
            onClick={() => overrideRequest(v.id)}
            className="text-xs border border-[#e6e7e8] rounded-md px-2 py-1 hover:bg-[#f8f8f8]"
          >
            Override & approve
          </button>
        )}
        ...
        {!readOnly && (
          <button
            ...
            className="text-[#222222]/40 hover:text-[#966eed]"
          >
            <X size={14} />
          </button>
        )}
...
function TradeCard({
  ...
  const radA = radById(reqA.radId),
    radB = radById(reqB.radId);
  const hasIssues =
    review && (review.violA.length > 0 || review.violB.length > 0);
    ...
    <div className="bg-white border border-[#e6e7e8] rounded-xl p-4 text-sm">
      <div className="flex items-center justify-between">
        <div>
          ...
          <SpecialtyBadges specialties={radA.specialties} />
          <span className="mx-2 text-[#222222]/40">
            <ArrowRightLeft size={12} className="inline" />
          </span>
          <span className="font-medium text-[#211c35]">{radB.name}</span>{' '}
          <SpecialtyBadges specialties={radB.specialties} />
        </div>
        <span
          className={`text-xs font-semibold px-2 py-0.5 rounded-full ${statusStyle(
            t.status === 'completed'
      ...
      <div className="text-[#222222]/60 text-xs mt-1">
        {radA.name.replace('Dr. ', '')}: {fmtShort(reqA.start)}&ndash;
        {fmtShort(reqA.end)} &rarr; {fmtShort(reqB.start)}&ndash;
        {fmtShort(reqB.end)}
        <span className="mx-2">|</span>
        {radB.name.replace('Dr. ', '')}: {fmtShort(reqB.start)}&ndash;
        {fmtShort(reqB.end)} &rarr; {fmtShort(reqA.start)}&ndash;
        {fmtShort(reqA.end)}
      </div>
      ...
      {t.status === 'pending' && (
        <div className="mt-3">
          {!review && (
            <button
              onClick={() => reviewTrade(t)}
              className="text-xs border border-[#e6e7e8] rounded-md px-2 py-1.5 hover:bg-[#f8f8f8]"
            >
            ...
            <div>
              {hasIssues ? (
                <div className="flex items-start gap-2 text-xs text-[#966eed] bg-[#966eed]/10 rounded-md px-3 py-2 mb-2">
                  <AlertTriangle size={14} className="mt-0.5 shrink-0" />
                  <span>
                    {review.violA.length > 0 && (
                      <>
                        {radA.name.replace('Dr. ', '')}:{' '}
                        {summarizeViolations(review.violA).join('; ')}.{' '}
                      </>
                    )}
                    {review.violB.length > 0 && (
                      <>
                        {radB.name.replace('Dr. ', '')}:{' '}
                        {summarizeViolations(review.violB).join('; ')}.
                      </>
                    )}
                  </span>
                </div>
                ...
                <div className="flex items-center gap-2 text-xs text-[#4a449c] bg-[#635cc6]/10 rounded-md px-3 py-2 mb-2">
                  <CheckCircle2 size={14} /> No coverage impact &mdash; safe to
                  confirm.
                </div>
              )}
              <div className="flex gap-2">
                <button
                  onClick={() => finalizeTrade(t)}
                  className="bg-[#635cc6] hover:bg-[#4a449c] text-white text-xs font-medium px-3 py-1.5 rounded-md"
                >
                  {hasIssues ? 'Override & Confirm Swap' : 'Confirm Swap'}
                </button>
                <button
                  onClick={() => declineTrade(t.id)}
                  className="text-xs text-[#222222]/60 px-3 py-1.5"
                >
                  Decline
                </button>
              </div>
  ...
  return (
    <div>
      <p className="text-sm text-[#222222]/70 mb-4">
        Each cell shows how many qualified radiologists remain available after
        approved vacations. Green = buffer above minimum, amber = exactly at
        minimum, red = below minimum.
      </p>
      ...
      <div className="overflow-x-auto bg-white border border-[#e6e7e8] rounded-xl p-4 mb-6">
        <table className="border-collapse text-xs">
          <thead>
            <tr>
              <th className="text-left pr-3 pb-2 sticky left-0 bg-white font-semibold text-[#211c35]">
                Specialty
              </th>
              {mapDays.map((d) => (
                <th
                  key={d}
                  className="px-1 pb-2 font-normal text-[#222222]/50 whitespace-nowrap"
                >
                  {fmtShort(d)}
                </th>
              ))}
          ...
          <tbody>
            {SPECIALTIES.map((sp) => (
              <tr key={sp}>
                <td className="pr-3 py-1 sticky left-0 bg-white font-medium text-[#211c35] whitespace-nowrap">
                  {sp}
                </td>
                {mapDays.map((d) => {
                  ...
                  const color =
                    avail < min
                      ? 'bg-[#966eed]'
                      : avail === min
                      ? 'bg-[#e6e7e8] text-[#211c35] border border-[#966eed]/50'
                      : 'bg-[#635cc6]/15 text-[#211c35]';
                  return (
                    <td key={d} className="p-0.5">
                      <div
                        className={`w-7 h-7 flex items-center justify-center rounded font-semibold ${color} ${
                          avail < min ? 'text-white' : ''
                        }`}
                      >
                        {avail}
                      </div>
      ...
      <div className="flex items-center gap-4 text-xs text-[#222222]/60 mb-8">
        <span className="flex items-center gap-1.5">
          <span className="w-3 h-3 rounded bg-[#635cc6]/15 inline-block" />{' '}
          Above minimum
        </span>
        <span className="flex items-center gap-1.5">
          <span className="w-3 h-3 rounded bg-[#e6e7e8] border border-[#966eed]/50 inline-block" />{' '}
          At minimum
        </span>
        <span className="flex items-center gap-1.5">
          <span className="w-3 h-3 rounded bg-[#966eed] inline-block" /> Below
          minimum
        </span>
      </div>
        ...
        {SPECIALTIES.map((sp) => (
          ...
          >
            <span className="flex items-center gap-2">
              <Users size={13} className="text-[#222222]/40" />
              {sp}
            </span>
            <span className="text-[#222222]/60">
              min {COVERAGE_MIN[sp]} network-wide
            </span>
          </div>
        ))}
      </div>
